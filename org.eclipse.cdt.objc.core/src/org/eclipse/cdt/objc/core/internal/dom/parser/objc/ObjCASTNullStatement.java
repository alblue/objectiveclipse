...
public class ObjCASTNullStatement extends ASTNode implements IASTNullStatement {
    ...
    public ObjCASTNullStatement copy() {
        ObjCASTNullStatement copy = new ObjCASTNullStatement();
