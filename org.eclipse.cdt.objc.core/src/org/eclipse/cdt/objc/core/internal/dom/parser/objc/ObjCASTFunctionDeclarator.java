...
public class ObjCASTFunctionDeclarator extends ObjCASTDeclarator implements IASTStandardFunctionDeclarator {
    ...
    public ObjCASTFunctionDeclarator() {
    }

    public ObjCASTFunctionDeclarator(IASTName name) {
        super(name);
    }
    ...
    @Override
    public ObjCASTFunctionDeclarator copy() {
        ObjCASTFunctionDeclarator copy = new ObjCASTFunctionDeclarator();
