...
public class ObjCASTParameterDeclaration extends ASTNode implements IASTParameterDeclaration,
        IASTAmbiguityParent {

    private IASTDeclarator declarator;
    private IASTDeclSpecifier declSpec;

    public ObjCASTParameterDeclaration() {
    }

    public ObjCASTParameterDeclaration(IASTDeclSpecifier declSpec, IASTDeclarator declarator) {
