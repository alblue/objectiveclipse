...
public class ObjCDeclarationOptions extends DeclarationOptions {
    ...
    final public static int ALLOW_FAST_ENUM_EXPR = 0x40000;
    ...
    public static final ObjCDeclarationOptions IMPLEMENTATION_LIST = new ObjCDeclarationOptions(
            ALLOW_PROPERTY | NO_INITIALIZER | IS_IMPLEMENTATION | ALLOW_METHOD | ALLOW_PROTOCOL_MODIFIERS);

    public static final ObjCDeclarationOptions METHOD_PARAMETER = new ObjCDeclarationOptions(
            ALLOW_ABSTRACT | METHOD_PARAM | ALLOW_PROTOCOL_MODIFIERS);
    ...
    public static final ObjCDeclarationOptions INTERFACE_LIST = new ObjCDeclarationOptions(
            ALLOW_PROPERTY | NO_INITIALIZER | ALLOW_METHOD | ALLOW_PROTOCOL_MODIFIERS);
    ...
    public static final ObjCDeclarationOptions PROTOCOL_LIST = new ObjCDeclarationOptions(
            REQUIRE_ABSTRACT | NO_INITIALIZER | ALLOW_OPTIONALITY | ALLOW_METHOD | ALLOW_PROTOCOL_MODIFIERS);
    
    public static final ObjCDeclarationOptions FAST_ENUMERATOR = new ObjCDeclarationOptions(ALLOW_FAST_ENUM_EXPR | ALLOW_CONSTRUCTOR_INITIALIZER);
    ...
    final public boolean fAllowFastEnumeratorExpression;
    ...
    public ObjCDeclarationOptions(int options) {
        ...
        fAllowFastEnumeratorExpression = ((options & ALLOW_FAST_ENUM_EXPR) != 0) ? true : false;
    }
