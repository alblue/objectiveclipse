...
public class ObjCASTExpressionStatement extends ASTNode implements IASTExpressionStatement,
        IASTAmbiguityParent {

    private IASTExpression expression;

    public ObjCASTExpressionStatement() {
    }

    public ObjCASTExpressionStatement(IASTExpression expression) {
    ...
    public ObjCASTExpressionStatement copy() {
        ObjCASTExpressionStatement copy = new ObjCASTExpressionStatement();
