...
public class ObjCASTInitializerExpression extends ASTNode implements IASTInitializerExpression,
        IASTAmbiguityParent {

    private IASTExpression expression;

    public ObjCASTInitializerExpression() {
    }

    public ObjCASTInitializerExpression(IASTExpression expression) {
    ...
    public ObjCASTInitializerExpression copy() {
        ObjCASTInitializerExpression copy = new ObjCASTInitializerExpression();
