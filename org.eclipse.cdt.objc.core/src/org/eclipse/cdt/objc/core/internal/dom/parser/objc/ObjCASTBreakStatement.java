...
public class ObjCASTBreakStatement extends ASTNode implements IASTBreakStatement {
    ...
    public ObjCASTBreakStatement copy() {
        ObjCASTBreakStatement copy = new ObjCASTBreakStatement();
