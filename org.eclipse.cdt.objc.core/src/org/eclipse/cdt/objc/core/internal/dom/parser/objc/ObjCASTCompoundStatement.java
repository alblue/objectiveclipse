...
public class ObjCASTCompoundStatement extends ASTNode implements IASTCompoundStatement, IASTAmbiguityParent {

    private IASTStatement[] statements = null;
    private IScope scope = null;

    public ObjCASTCompoundStatement copy() {
        ObjCASTCompoundStatement copy = new ObjCASTCompoundStatement();
