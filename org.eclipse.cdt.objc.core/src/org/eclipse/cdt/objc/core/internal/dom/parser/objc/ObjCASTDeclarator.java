...
public class ObjCASTDeclarator extends ASTNode implements IASTDeclarator, IASTAmbiguityParent {
    ...
    public ObjCASTDeclarator() {
    }

    public ObjCASTDeclarator(IASTName name) {
        setName(name);
    }

    public ObjCASTDeclarator(IASTName name, IASTInitializer initializer) {
    ...
    public void addPointerOperator(IASTPointerOperator operator) {
        ...
        if (operator != null) {
            ...
            pointerOps = (IASTPointerOperator[]) ArrayUtil.append(IASTPointerOperator.class, pointerOps,
                    ++pointerOpsPos, operator);
        }
    }

    public ObjCASTDeclarator copy() {
        ObjCASTDeclarator copy = new ObjCASTDeclarator();
        copyBaseDeclarator(copy);
        return copy;
    }

    protected void copyBaseDeclarator(ObjCASTDeclarator copy) {
    ...
    public IASTPointerOperator[] getPointerOperators() {
        ...
        pointerOps = (IASTPointerOperator[]) ArrayUtil.removeNullsAfter(IASTPointerOperator.class,
                pointerOps, pointerOpsPos);
        return pointerOps;
    }
