...
public class ObjCASTExpressionList extends ASTNode implements IASTExpressionList, IASTAmbiguityParent {
    ...
    public ObjCASTExpressionList copy() {
        ObjCASTExpressionList copy = new ObjCASTExpressionList();
