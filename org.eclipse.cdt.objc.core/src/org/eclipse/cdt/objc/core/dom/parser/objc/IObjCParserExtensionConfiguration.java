 ...
 * Swartz (Nokia) Anton Leherbauer (Wind River Systems) Markus Schorn (Wind
 * River Systems)
 *******************************************************************************/
 ...
 *              {@link AbstractObjCParserExtensionConfiguration} instead.
 * @noextend This interface is not intended to be extended by clients.
 * 
 * @see "http://gcc.gnu.org/onlinedocs/gcc/C-Extensions.html"
 * @since 4.0
 */
public interface IObjCParserExtensionConfiguration {
    ...
    /**
     * Skips information in brackets provided at the beginning of a parameter
     * declaration: <br>
    ...
    /**
     * Support additional parameters for the sizeof operator: 'sizeof' '('
     * typeid ',' expression-list ')'
     * 
     * @since 5.1
     */
    ...
    /**
     * Support function style assembler definitions: 'asm' ['volatile']
     * [return-type] name '(' parameter-list ')' '{' assembler-code '}'
     * 
     * @since 5.1
     */
