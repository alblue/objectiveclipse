 ...
 */
public interface IObjCASTArrayDesignator extends IObjCASTDesignator {

    /**
     * <code>SUBSCRIPT_EXPRESSION</code> represents the relationship between the
     * designator and the subscript expression.
     */
     ...
     * @since 5.1
     */
    public IObjCASTArrayDesignator copy();
}
